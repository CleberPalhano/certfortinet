...
Invoke-WebRequest -Uri https://raw.githubusercontent.com/CleberPalhano/certfortinet/main/Certificado%20Rede%20Educacional%20-%20Fortinet.crt -OutFile C:\FIEP\CertFiep.crt;
